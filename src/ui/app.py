...
#                                 )
#                                 st.session_state['generated_content'] = "Your PPT has been generated!"
#                                 if isinstance(inputs['external_content'], str) and os.path.exists(
#                                         inputs['external_content']):
#                                     os.remove(inputs['external_content'])
#                                 os.remove(path)
#                             except Exception as e:
#                                 st.error(str(e)+"\nTry Generating again if you get a JSON Error.")
#                             st.success("Content generation complete!")
...
def safe_remove(filepath):
    """Safely remove a file if it exists and is a valid path."""
